...
#define angle_centre 87
byte angle_difference_xs = 3;
byte angle_difference_small = 6;
byte angle_difference_midsmall = 9;
byte angle_difference_medium = 12;
byte angle_difference_midlarge = 15;
byte angle_difference_large = 22;
byte angle_difference_xl = 32;
byte angle_left_xs;
...
void loop() {
...

  {
    if (millis() - startMillis < 200){
      if(tangential_position == 8 || tangential_position == 7 || tangential_position == 9)
        if (countersteer == 1){
          angle += 15;
          countersteer = 0;
        }
  ...
  //****************************************************************
  {
    ...
    else if (tangential_position == 1 || tangential_position == 2 || tangential_position == 14 || tangential_position == 15 ) {
