...
byte angle_difference_xs = 2;
byte angle_difference_small = 4;
byte angle_difference_midsmall = 6;
byte angle_difference_medium = 8;
byte angle_difference_midlarge = 10;
byte angle_difference_large = 20;
